...
//                     {toys.map(toy => (
//                         <tr key={toy.id}>
//                             <td><img src={toy.pictureUrl} alt="" style={myImageStyle}/></td>
//                             <td>&nbsp;{toy.name}</td>
...
//                             <td>
//                               <Link to={`/updatetoy/${toy._id}`}><button className='btn btn-primary mx-1' >Update</button></Link>
//                                 <button onClick={()=> Delete(toy._id)} className='btn btn-danger' >Delete</button>
//                             </td>
//                         </tr>
//                     ))}
//                 </tbody>
...
//         {/* Add more buttons for other fields if desired */}
//       </div>
//       <table className='table'>
//         <thead>
//           <tr>
